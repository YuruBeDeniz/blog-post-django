    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('posts', models.ManyToManyField(blank=True, related_name='user_blog_posts', to='blogpost.blogpost')),
                ('topics', models.ManyToManyField(blank=True, related_name='user_blog_topics', to='blogtopic.blogtopic')),
